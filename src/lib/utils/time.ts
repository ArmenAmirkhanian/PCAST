...
// Whether the live NWS forecast can serve a given start deliberately has no
// helper here. It is not a calendar question — it depends on how far ahead NWS
// has actually issued data for that grid cell, which moves every hour. See
// `assessCoverage` in `$lib/server/nws-parse`.
